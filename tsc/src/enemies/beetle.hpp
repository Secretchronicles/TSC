...
namespace TSC {
	...
	public:
		...
		void Move_Random(float distance);
		...
		void Do_Beetle_Barrage_Generation(float fly_distance, float fly_speed, float rand_direction);
	...
	private:
		...
		float m_move_time; // herlp, I don't know if this goes here
		float m_movement_smoothness;
